          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 w-full">
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900 dark:text-white">Banner Details</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Internal Title:</span>
              ...
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900 dark:text-white">Action & Status</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">

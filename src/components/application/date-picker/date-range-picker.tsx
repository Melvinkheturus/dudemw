...
export const DateRangePicker = ({ value: valueProp, defaultValue, onChange, onApply, onCancel, compact = false, ...props }: DateRangePickerProps) => {
    ...
    return (
        <AriaDateRangePicker aria-label="Date range picker" shouldCloseOnSelect={false} {...props} value={value} onChange={setValue}>
            <AriaGroup>
                <Button size={compact ? "sm" : "md"} color="secondary" iconLeading={CalendarIcon}>
            ...
            >
                <AriaDialog className={cx("flex rounded-2xl bg-white shadow-xl ring ring-gray-200 focus:outline-hidden", compact && "scale-90")}>
                    {({ close }) => (
                        <>
                            {!compact && (
                            ...
                            <div className="flex flex-col">
                                ...
                                />
                                <div className={cx("flex justify-between gap-3 border-t border-secondary", compact ? "p-3" : "p-4")}>
                                    {!compact && (
                                    ...
                                    <div className={cx("grid w-full grid-cols-2 gap-3", !compact && "md:flex md:w-auto")}>
                                        <Button
                                            size={compact ? "sm" : "md"}
                                            color="secondary"
                                            onClick={() => {

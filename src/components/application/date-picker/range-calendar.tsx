            ...
            >
                <div className="flex flex-col gap-2 px-3 py-2">
                    <header className="relative flex items-center justify-between">
                        <Button slot="previous" iconLeading={ChevronLeft} size="sm" color="tertiary" className="size-6" />

                        <h2 className="text-xs font-semibold text-fg-secondary">
                            <RangeCalendarTitle part="start" />
                        </h2>

                        <Button slot="next" iconLeading={ChevronRight} size="sm" color="tertiary" className="size-6" />
                    </header>
                        ...
                        <AriaCalendarGridHeader>
                            {(day) => (
                                <AriaCalendarHeaderCell className="border-b-4 border-transparent p-0">
                                    <div className="flex size-6 items-center justify-center text-xs font-medium text-secondary">{day.slice(0, 2)}</div>
